...
class Depoimento extends Model
{
    ...
    public function getTodosDepoimentos()
    {
        ...
        $sql = "SELECT nome_cliente, cidade_cliente, sigla_uf, descricao_depoimento, datahora_depoimento, nota_depoimento, status_depoimento, foto_cliente, alt_foto_cliente FROM tbl_depoimento d
