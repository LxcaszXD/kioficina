<form method="POST" action="http://localhost/kioficina/public/clientes/editar/<?php echo $cliente['id_cliente']; ?>" enctype="multipart/form-data">
    <div class="container my-5">
        <div class="row">
            <div class="col-md-3">
                <img id="preview-img"
                    src="<?php echo isset($cliente['foto_cliente']) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/kioficina/public/uploads/' . $cliente['foto_cliente']) ? 'http://localhost/kioficina/public/uploads/' . $cliente['foto_cliente'] : 'http://localhost/kioficina/public/uploads/sem-foto.png'; ?>"
                    alt="Foto do Cliente"
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" id="senha_cliente" name="senha_cliente" value="<?php echo htmlspecialchars($cliente['senha_cliente']); ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="telefone_cliente" name="telefone_cliente" value="<?php echo htmlspecialchars($cliente['telefone_cliente']); ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label for="endereco_cliente" class="form-label">Endereço:</label>
                        <input type="text" class="form-control" id="endereco_cliente" name="endereco_cliente" value="<?php echo htmlspecialchars($cliente['endereco_cliente']); ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="bairro_cliente" name="bairro_cliente" value="<?php echo htmlspecialchars($cliente['bairro_cliente']); ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label for="cidade_cliente" class="form-label">Cidade:</label>
                        <input type="text" class="form-control" id="cidade_cliente" name="cidade_cliente" value="<?php echo htmlspecialchars($cliente['cidade_cliente']); ?>" required>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="id_uf" name="id_uf" required>
                            ...
                            <?php foreach ($estados as $linha): ?>
                                <option value="<?php echo $linha['id_uf']; ?>" <?php echo $cliente['id_uf'] == $linha['id_uf'] ? 'selected' : ''; ?>><?php echo $linha['nome_uf']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="http://localhost/kioficina/public/clientes" class="btn btn-secondary">Cancelar</a>
                </div>
            </div>
        </div>
    </div>
