...
<div class="container my-5">
  <div class="row">
    <!-- Imagem do Cliente -->
    <div class="col-md-4">
      <img src="http://localhost/kioficina/public/uploads/cliente/sem-foto-cliente.png" alt="Kioficina Logo" class="img-fluid" id="preview-img" style="width:100%; cursor:pointer;">
