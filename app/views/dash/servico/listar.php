...
<a href="http://localhost/kioficina/public/servicos/adicionar" class="btn btn-secondary" style="margin-bottom: 10px;">
    Adicionar
</a>
    ...
    <tbody>
        <?php foreach ($listaServico as $linha): ?>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" href="http://localhost/kioficina/public/servicos/editar/<?php echo $linha['id_servico']; ?>" title="Editar">
