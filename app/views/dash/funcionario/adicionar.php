<form method="POST" action="http://localhost/kioficina/public/funcionarios/adicionar" enctype="multipart/form-data">
    <div class="container my-5">
        <div class="row">
            <div class="col-md-3">
                <img id="preview-img"
                    src="http://localhost/kioficina/public/uploads/sem-foto.png"
