<form method="POST" action="http://localhost/kioficina/public/fornecedores/adicionar" enctype="multipart/form-data">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="cpf_cnpj_fornecedor" name="cpf_cnpj_fornecedor" required>
                    </div>
                    <div class="col-md-6">
                        <label for="data_cad_fornecedor" class="form-label">Data de Cadastro:</label>
                        <input type="date" class="form-control" id="data_cad_fornecedor" name="data_cad_fornecedor" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="site_fornecedor" name="site_fornecedor">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="endereco_fornecedor" name="endereco_fornecedor" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="bairro_fornecedor" name="bairro_fornecedor" required>
                    </div>
                    <div class="col-md-6">
                        <label for="cidade_fornecedor" class="form-label">Cidade:</label>
                        <input type="text" class="form-control" id="cidade_fornecedor" name="cidade_fornecedor" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="status_fornecedor" name="status_fornecedor" required>
